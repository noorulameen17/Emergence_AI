...
const MotionDiv = dynamic(
  () => import("motion").then((mod) => mod.motion.div),
  { ssr: false }
);

const LoaderComponent = dynamic(() => import("./components/LoaderComponent"), {
  ssr: false,
  loading: () => (
